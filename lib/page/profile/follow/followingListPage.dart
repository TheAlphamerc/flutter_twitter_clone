...
class _FollowingListPageState extends State<FollowingListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
          authstate.followingList != null && authstate.followingList.isNotEmpty
              ? ListView.separated(
                  itemBuilder: (context, index) {
                    return FutureBuilder(
                      future: notificationState
                          .getuserDetail(authstate.followingList[index]),
                  ...
                  itemCount: authstate.followingList.length,
                )
              : Container(
                  width: fullWidth(context),
                  padding: EdgeInsets.only(top: 0, left: 30, right: 30),
                  child: NotifyText(
                    title: 'User is not following anyone.',
                    subTitle: '',
                  ),
                ),
    );
