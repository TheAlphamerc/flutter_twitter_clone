...
class SidebarMenu extends StatefulWidget {
  ...
  const SidebarMenu({Key key, this.scaffoldKey})
      : super(key: key); //= new GlobalKey<ScaffoldState>();
          ...
          Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  customText('${state.userModel.followers ?? 0}',
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
                  customText(' Followors',
                      style: TextStyle(color: Colors.black54, fontSize: 17)),
                  SizedBox(
                    width: 10,
                  ),
                  customText('${state.userModel.following ?? 0}' ?? '0',
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
