         ...
         children: <Widget>[
            ...
            Container(
              ...
              child:Row(
                children: <Widget>[
                SizedBox(width: 40,),
                customText(state.userModel.followers.toString(),style:TextStyle(fontWeight: FontWeight.bold,fontSize:17)),
                customText(' Followors',style:TextStyle(color: Colors.black54,fontSize:17)),
                SizedBox(width: 10,),
                customText(state.userModel.following.toString(),style:TextStyle(fontWeight: FontWeight.bold,fontSize:17)),
